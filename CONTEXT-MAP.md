...
| 业务上下文 | 先读入口 | 典型代码范围 |
| --- | --- | --- |
| Device 与本地执行 | [`Device Service`](./CONTEXT.md#device-service)、[`Supported user device platform`](./CONTEXT.md#supported-user-device-platform)、[`Server Manager runtime`](./CONTEXT.md#server-manager-runtime) | `apps/daemon-next`、设备安装/升级、Workspace 与本地执行 |
...
| PI promotion 与根任务编排 | [`PI Manager`](./CONTEXT.md#pi-manager)、[`Promotion gate`](./CONTEXT.md#promotion-gate)、[`PI orchestration run`](./CONTEXT.md#pi-orchestration-run)、[`Root Task lifecycle`](./CONTEXT.md#root-task-lifecycle) | PI 管理运行时、根 Task、DAG、调度、恢复与系统活动投影 |
