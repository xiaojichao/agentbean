...
| Message、Inbox 与 Attention | [`Message delivery`](./CONTEXT.md#message-delivery)、[`Channel Work Intake`](./CONTEXT.md#channel-work-intake)、[`Message Route Analysis`](./CONTEXT.md#message-route-analysis)、[`Inbox item`](./CONTEXT.md#inbox-item)、[`System attention item`](./CONTEXT.md#system-attention-item) | Server message/intake/inbox、socket 投影、Web 消息与未读体验 |
...
| PI promotion 与根任务编排 | [`PI Manager`](./CONTEXT.md#pi-manager)、[`Server-authorized semantic trigger`](./CONTEXT.md#server-authorized-semantic-trigger)、[`Server Manager runtime`](./CONTEXT.md#server-manager-runtime)、[`Promotion gate`](./CONTEXT.md#promotion-gate)、[`PI orchestration run`](./CONTEXT.md#pi-orchestration-run)、[`Root Task lifecycle`](./CONTEXT.md#root-task-lifecycle) | PI 消息路由、管理运行时、根 Task、DAG、调度、恢复与系统活动投影 |
...
| Agent 能力、Skill 与候选匹配 | [`Capability Registry`](./CONTEXT.md#capability-registry)、[`Capability Evidence`](./CONTEXT.md#capability-evidence)、[`Agent Capability Directory`](./CONTEXT.md#agent-capability-directory)、[`Agent Exposure Manifest`](./CONTEXT.md#agent-exposure-manifest)、[`Agent Auto-accept Policy`](./CONTEXT.md#agent-auto-accept-policy)、[`Agent eligibility`](./CONTEXT.md#agent-eligibility) | Agent capability discovery/verification/exposure、候选过滤/排序、Team/Channel eligibility 与自动接受 |
| 文件、Artifact 与交付审核 | [`Artifact source root`](./CONTEXT.md#artifact-source-root)、[`Channel file index`](./CONTEXT.md#channel-file-index)、[`Output package`](./CONTEXT.md#output-package)、[`Task delivery revision`](./CONTEXT.md#task-delivery-revision)、[`Task delivery acceptance`](./CONTEXT.md#task-delivery-acceptance) | Channel Files、artifact/version、OutputPackage、delivery revision、review/final/acceptance |
