...
- 日期：2026-06-25
- 基线：`origin/main` = `dd02c76`（PR #355 已合并）
- GitHub 状态：以当前 PR/Actions 为准；本表只记录 parity 证据状态。
- 最新 main CI/CD：PR #355 合并后的 main run `28143066376` 已成功，包含 Validate web/server/daemon/AgentBean Next、Deploy production、Publish agent to npm 与 AgentBean Next production smoke；后续 main 提交需继续按 Actions truth 核对。
