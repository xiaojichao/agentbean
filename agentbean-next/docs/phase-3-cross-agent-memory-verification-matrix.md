...
> 原因：合同与 Domain 安全边界已开始实现；存储、Capsule、Candidate、Device 本地 Memory、Web 和真实跨 Agent 验证尚未完成。Phase 3 runtime 必须保持关闭。
...
| P3-03 | Red | Server SQLite schema、repository 与原子事务 | 未实现 |
...
| P3-15 | Red | grant 撤销、来源失效、expire/delete 与审计闭环 | 未实现 |
