...
| E2E-06 | production cutover 前必须按 runbook 完成 repository variable/secret、Railway volume/env、production readiness、deploy flip、smoke 与 rollback 验证。 | Ops | 防止把本地 preview readiness 误当成生产替换完成。 | `production-cutover-runbook.md`, `migration-plan.md` |
