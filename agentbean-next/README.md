...
- `apps/web-next`：web socket client、静态 preview 页面、register/login fallback、channel create/update/member commands、device scan command、agent/channel/device subscriptions、message/dispatch/device realtime events、reconnect resubscription 与最小 session/state 边界。
