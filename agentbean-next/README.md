...
- `apps/daemon-next`：daemon protocol client、stub executor、reconnect re-announcement、device/runtimes reports、targeted rescan command 与 dispatch error/env 边界。
