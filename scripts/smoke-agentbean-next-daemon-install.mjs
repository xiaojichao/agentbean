...
export function runAgentBeanNextDaemonInstallSmoke({
  ...
  try {
    ...
    run(process.execPath, [
      '--input-type=module',
      '--eval',
      "const runtime = await import('@agentbean/pi-management-runtime'); if (typeof runtime.createManagementRuntimeFactory !== 'function' || runtime.PHASE_1_MANAGEMENT_TOOL_NAMES?.length !== 11 || runtime.PHASE_2_MANAGEMENT_TOOL_NAMES?.length !== 24 || !runtime.PHASE_2_MANAGEMENT_TOOL_NAMES.includes('tasks.create_subtasks') || !runtime.PHASE_2_MANAGEMENT_TOOL_NAMES.includes('tasks.cancel') || !runtime.PHASE_2_MANAGEMENT_TOOL_NAMES.includes('tasks.close') || !runtime.PHASE_2_MANAGEMENT_TOOL_NAMES.includes('agents.list_available') || !runtime.PHASE_2_MANAGEMENT_TOOL_NAMES.includes('handoffs.request') || !runtime.PHASE_2_MANAGEMENT_TOOL_NAMES.includes('handoffs.await_result')) process.exit(1);",
    ], { cwd: installDir });
    run(process.execPath, [
      '--input-type=module',
      '--eval',
