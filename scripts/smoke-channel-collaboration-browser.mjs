...
import {
  ...
  runAgentBeanChannelCollaborationBrowserSmoke,
...
if (process.argv[1] === fileURLToPath(import.meta.url)) {
  ...
  const summary = await runAgentBeanChannelCollaborationBrowserSmoke({
    baseUrl: args.url ?? process.env.AGENTBEAN_NEXT_CHANNEL_COLLABORATION_URL,
