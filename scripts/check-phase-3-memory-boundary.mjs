...
if (!managementWorkerV2.includes('Phase3ManagementWorkerToolInputMapV1')
  ...
  || !managementWorkerV2.includes('Phase3MemoryToolResultV3')
  || !managementWorkerV2.includes('parsePhase3MemoryToolResultV3')
  || !managementWorkerV2.includes('assertPhase3MemoryToolOutput')
...
if (scripts['test:phase3-memory-boundary'] !== 'node --test scripts/check-phase-3-memory-boundary.test.mjs'
  ...
  || !String(scripts['test:phase3-memory-persistence']).startsWith('npm run build:pi-management-runtime && ')
  ...
  || !String(scripts['test:phase3-memory-daemon']).startsWith('npm run build:pi-management-runtime && ')
