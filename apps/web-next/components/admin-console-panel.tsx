...
const SECTION_TITLE: Record<AdminConsoleSection, string> = {
  teams: '团队管理',
  users: '用户管理',
  devices: '设备管理',
  agents: 'Agent 管理',
 ...
 */
export function AdminConsolePanel({ section }: { section: AdminConsoleSection }) {
      ...
      <div className="flex-1 overflow-y-auto p-6">
        ...
        {selectedDevice && (
          <DeviceDetailDialog
            ...
            users={users}
            onTransferOwner={handleTransferDeviceOwner}
