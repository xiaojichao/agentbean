...
export function registerWebSocketHandlers(
  ...
  const afterAgentExposureMutation = (payload: unknown, result: unknown) =>
    options.afterAgentExposureMutation?.(payload, result);
  ...
  bind(socket, WEB_EVENTS.agentExposure.publish, app, 'publishAgentExposure', afterAgentExposureMutation, { authenticatedUser: options.authenticatedUser });
  bind(socket, WEB_EVENTS.agentExposure.revoke, app, 'revokeAgentExposure', afterAgentExposureMutation, { authenticatedUser: options.authenticatedUser });
  ...
  bind(socket, WEB_EVENTS.task.stageDeliveryReviewWorkspace, app, 'queryStageDeliveryReviewWorkspace', undefined, {
    authenticatedUser: options.authenticatedUser,
    requireAuthenticatedUser: true,
  });
