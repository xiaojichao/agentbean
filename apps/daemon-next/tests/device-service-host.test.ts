...
describe('Device Service paths and state', () => {
  test('keeps control, state, lock and logs under the AgentBean service root', () => {
    expect(deviceServicePaths('/tmp/agentbean-home')).toEqual({
      ...
      migrationJournalFile: '/tmp/agentbean-home/service/migration.json',
      migrationLockDirectory: '/tmp/agentbean-home/service/migration.lock',
      legacyRuntimeDirectory: '/tmp/agentbean-home/service/legacy-runtimes',
