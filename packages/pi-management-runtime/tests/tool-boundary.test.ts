...
describe('Phase 3 Memory tool definitions', () => {
  ...
  it('publishes exact schemas for every Phase 3 Memory tool', () => {
    ...
    const expectedKeys = new Map([
      ...
      ['memory.propose_candidate', ['sourceAgentId', 'sourceInvocationId', 'targetAgentId', 'scopeType', 'scopeRef', 'contentKind', 'proposedContent', 'proposedSummary', 'sourceRefs', 'taskId']],
    ...
    const expectedRequired = new Map([
      ...
      ['memory.propose_candidate', ['sourceAgentId', 'sourceInvocationId', 'targetAgentId', 'scopeType', 'scopeRef', 'contentKind', 'proposedContent', 'sourceRefs']],
      ['memory.link_sources', ['memoryId', 'sourceRefs']],
    ]);
